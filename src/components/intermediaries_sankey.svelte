<main>
    ...
    <html lang="en">
        ...
        <body>
            ...
            <div class="sidebar">
                <h1 style="float: left;">Family Type</h1>
                <h1 style="float: right;">% of Remittances Spent on Intermediaries</h1>
            </div>
            <p id="sankey">
                ...
                <script type="text/javascript">
                    ...
                    var colorScale = d3.scale.ordinal()
                        .domain(["Single Mother", "Biparental"])
                        .range(["purple", "black"]);
                    var svg = d3
                        .select("svg")
